...
#define MISTAKE 1
	...
	#define BAUD_PRESCALE (int)round(((((double)F_CPU / ((double)115200 * 8.0))) - MISTAKE))	/* Define prescale value */
#else
	#define BAUD_PRESCALE (int)round(((((double)F_CPU / ((double)115200 * 16.0))) - MISTAKE))	/* Define prescale value */
#endif
